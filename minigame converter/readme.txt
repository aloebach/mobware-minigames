...
example: The following command will take the playdate code found in the directory "Asheteroids", create a minigame named "asheteroids"

python3 convert2minigame.py Asheteroids --name asheteroids
