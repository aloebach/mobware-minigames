...
import "extras/rescues/pulp-audio.lua"
...
function rescues.cranked(change, acceleratedChange)
...
function rescues.crankUndocked()
    local script = pulp:getPlayerScript()
    if script then
