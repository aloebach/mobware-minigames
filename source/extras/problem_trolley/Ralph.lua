...
ralph_spriteSheet = gfx.imagetable.new("extras/problem_trolley/images/Ralph")
victory_spriteSheet = gfx.imagetable.new("extras/problem_trolley/images/Ralph_victory")
defeat_spriteSheet = gfx.imagetable.new("extras/problem_trolley/images/Ralph_defeated")
switch_spriteSheet = playdate.graphics.imagetable.new("extras/problem_trolley/images/track_switch")
