...
gfx.lockFocus(canvas)
	...
	text_box:drawInRect(window_width / 4 - 16, 30 - 32, 64, 64)
	rock_icon:draw(window_width / 4 , 30 - 16) 
	text_box:drawInRect(window_width / 4 - 16, 120 - 32, 64, 64)
	paper_icon:draw(window_width / 4 , 120 - 16) 
	text_box:drawInRect(window_width / 4 - 16, 210 - 32, 64, 64)
	scissors_icon:draw(window_width / 4 , 210 - 16) 
gfx.unlockFocus()
