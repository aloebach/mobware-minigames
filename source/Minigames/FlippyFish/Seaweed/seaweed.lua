...
function Seaweed:init()
	...
	self.seaweedTop:setImage(playdate.graphics.image.new('Minigames/FlippyFish/Seaweed/seaweedTop'))
	...
	self.seaweedBottom:setImage(playdate.graphics.image.new('Minigames/FlippyFish/Seaweed/seaweedBottom'))
